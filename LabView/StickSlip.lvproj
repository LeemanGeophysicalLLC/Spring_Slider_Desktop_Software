	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Build Specifications" Type="Build">
			<Item Name="Stick Slip Installer" Type="Installer">
				...
				<Property Name="Source[0].File[0].Shortcut[0].name" Type="Str">StickSlipDemo</Property>
				<Property Name="Source[0].File[0].Shortcut[0].subDir" Type="Str">StickSlip</Property>
				<Property Name="Source[0].File[0].Shortcut[1].destIndex" Type="Int">1</Property>
				<Property Name="Source[0].File[0].Shortcut[1].name" Type="Str">StickSlipDemo</Property>
				<Property Name="Source[0].File[0].Shortcut[1].subDir" Type="Str">StickSlip</Property>
				<Property Name="Source[0].File[0].Shortcut[2].destIndex" Type="Int">2</Property>
				<Property Name="Source[0].File[0].Shortcut[2].name" Type="Str">StickSlipDemo</Property>
				<Property Name="Source[0].File[0].Shortcut[2].subDir" Type="Str">StickSlip</Property>
